...
import com.example.guihuan.chatwifitest.jsip_ua.impl.SoundManager;

public interface IDevice  extends ISipEventListener{

	void Register(String to, String message);
	...
	void SendMessage(String to, String message, String method);
